...
```bash
microk8s kubectl exec -it  busybox-multitool-cb6c4549-fqwmh -c busybox -- /bin/sh
```

![image](https://github.com/user-attachments/assets/26af46b6-9275-4177-a0af-f514332bb6fc)
